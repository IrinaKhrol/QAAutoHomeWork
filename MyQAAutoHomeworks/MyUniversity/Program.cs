...
internal class Program
{
    ...
    {
        UniversityEmployee employee1 = new Teacher (new Person("Ivan", "Ivanov"),0101,
                                            new Course("Phyth", "Qvantum Theory"));

        UniversityEmployee employee2 = new DegreeTeacher(new Person("Irina", "Chernyavskaya"), 0201,
                                            new Course("Biology", "Brain"),
                                            "Masterdegree", "Docent");

        UniversityEmployee employee3 = new DegreeTeacher(new Person("Olga", "Volnaya"), 0301,
                                            new Course("Chemistry", "Air"),
                                            "Proffessor", "Docent");

        UniversityEmployee employee4 = new SupportStaff(new Person("Igor", "Krylov"), 0401,
                                            " Driver", "Driver Children");

        UniversityEmployee employee5 = new SupportStaff(new Person("Peter", "Pen"), 0501,
